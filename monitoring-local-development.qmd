...
[VIIRS annual composite, population-weighted municipal means · 2017ordinary least squares, in-sample]{.source}


## Daytime embeddings: new predictors to study local development {.figure-with-quote}

- A collection of satellite images of one patch of land, compressed into **64** numbers.
  - Intuition: Similar to a principal component analysis applied to satellite imagery
- Learned with no social, economic, or luminosity data.

![](figures/fig-dte-alphaearth.png){fig-align="center"}
...
## On the raw average, the nighlights win the headline goals
...
> Poverty leaves a footprint visible from ourter space (R² = **0.69**); institutions leave none (**−0.05**).
...
Poverty's clusters and traps reappear: **80%** agreement with the actual map.
:::
:::
